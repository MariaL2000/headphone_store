...
export const imageSlides = [
  {
    id: 1,
    src: "https://wallpapercave.com/wp/wp7442748.jpg",
    alt: "Headphone 1",
    textLists: ["High quality sound"],
  },
  {
    id: 2,
    src: car1,
    alt: "Headphone 2",
    textLists: ["Noise cancellation"],
  },
  {
    id: 3,
    src: car2,
...
export const headphoneData = [
  {
    ...
    subtitle:
      "Dive into crystal-clear sound with deep bass and an ergonomic design for endless hours of music without interruptions.",
    price: "$100",
    modal: "Modal Brown",
    bgColor: "#8b5958",
  },
  {
    id: 2,
    image: headphone2,
    title: "Wireless Headphones Lime Green",
    subtitle:
      "Feel the energy of lime color and the power of pure audio: live your songs as if you were at a live concert.",
    price: "$120",
    modal: "Lime Green",
    bgColor: "#638153",
  },
  {
    id: 3,
    image: headphone3,
    title: "Wireless Headphones Ocean Blue",
    subtitle:
      "Inspired by the calm of the ocean: noise-cancelling headphones with an elegant blue design that redefines your listening experience.",
    price: "$150",
    modal: "Ocean Blue",
    bgColor: "#5d818c",
  },
